...
describe("addMissingTextToCategorizedComments", () => {
  it("should add missing text to categorized comments", () => {
    ...
    expect(result).toEqual([
      { id: "1", text: "This is comment 1", topics: [{ name: "Topic 1", subtopics: [] }] },
      { id: "2", text: "This is comment 2", topics: [{ name: "Topic 2", subtopics: [] }] },
    ]);
  });
...
describe('validateCategorizedComments', () => {
  ...
  it('should return all comments as valid with correct input', () => {
    const categorizedComments: Comment[] = [
      { id: "1", text: "Comment 1", topics: [{ name: "Topic 1", subtopics: [{ name: "Subtopic 1" }] }] },
  ...
  it('should filter out extra comments', () => {
    const categorizedComments: Comment[] = [
      { id: "1", text: "Comment 1", topics: [{ name: "Topic 1", subtopics: [{ name: "Subtopic 1" }] }] },
      { id: "2", text: "Comment 2", topics: [{ name: "Topic 2", subtopics: [{ name: "Subtopic 2" }] }] },
      { id: "3", text: "Extra comment", topics: [{ name: "Topic 1", subtopics: [{ name: "Subtopic 1" }] }] },
    ];
    const {
      commentsPassedValidation,
      commentsWithInvalidTopics
  ...
  it('should filter out comments with empty subtopics', () => {
    const categorizedComments: Comment[] = [
      { id: "1", text: "Comment 1", topics: [{ name: "Topic 1", subtopics: [{ name: "Subtopic 1" }] }] },
      { id: "2", text: "Comment 2", topics: [{ name: "Topic 2", subtopics: [] }] },
    ];
    const {
      commentsPassedValidation,
      commentsWithInvalidTopics
  ...
  it('should filter out comments with invalid topic names', () => {
    const categorizedComments: Comment[] = [
      { id: "1", text: "Comment 1", topics: [{ name: "Topic 1", subtopics: [{ name: "Subtopic 1" }] }] },
      { id: "2", text: "Comment 2", topics: [{ name: "Invalid Topic", subtopics: [{ name: "Subtopic 2" }] }] },
    ];
    const {
      commentsPassedValidation,
      commentsWithInvalidTopics
  ...
  it('should filter out comments with invalid subtopic names', () => {
    const categorizedComments: Comment[] = [
      { id: "1", text: "Comment 1", topics: [{ name: "Topic 1", subtopics: [{ name: "Subtopic 1" }] }] },
      { id: "2", text: "Comment 2", topics: [{ name: "Topic 2", subtopics: [{ name: "Invalid Subtopic" }] }] },
    ];
    const {
      commentsPassedValidation,
      commentsWithInvalidTopics
  ...
  it('should allow "Other" as a valid topic or subtopic name', () => {
    const categorizedComments: Comment[] = [
      { id: "1", text: "Comment 1", topics: [{ name: "Other", subtopics: [{ name: "Other Subtopic 1" }] }] },
      { id: "2", text: "Comment 2", topics: [{ name: "Topic 2", subtopics: [{ name: "Other" }] }] },
    ];
    const {
      commentsPassedValidation,
      commentsWithInvalidTopics
