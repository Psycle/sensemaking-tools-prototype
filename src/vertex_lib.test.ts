...
describe("VertexLibTest", () => {
  ...
  it("should format comments with vote tallies via formatCommentsWithVotes", () => {
    expect(formatCommentsWithVotes([
      ...
      { commentText: "comment2",
        groupVoteTallies: {
          "0": {agreeCount: 2, disagreeCount: 5, passCount: 3, totalCount: 10},
          "1": {agreeCount: 5, disagreeCount: 3, passCount: 2, totalCount: 10}}}])).toEqual([
      `comment1
